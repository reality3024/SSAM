...
def train_target(args):
    ...
    while iter_num < max_iter:
        try:
            inputs_test, y, tar_idx, path = next(iter_test)
        except:
        ...
        entincorrect = torch.where(targets_u[indx] != y[indx])[0]
        # print(pseudo_label[indx])
        # print(len(entincorrect))
        # num += len(entincorrect)

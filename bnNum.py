    ...
    while iter_num < max_iter:
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            if args.dset == 'VISDA-C':
                ...
                log_str = 'Task: {}, Iter:{}/{}; Accuracy = {:.2f}%; bn number:{}'.format(args.name, iter_num, max_iter, acc_s_te, cnt)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--bncnt', type=int, default=53)

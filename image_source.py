...
def data_load(args): 
    ...
    dsets["source_tr"] = ImageList(tr_txt, transform=image_train(), root=root_path)
    dset_loaders["source_tr"] = DataLoader(dsets["source_tr"], batch_size=train_bs, shuffle=True, num_workers=args.worker, drop_last=False)
    
    dsets["source_te"] = ImageList(te_txt, transform=image_test(), root=root_path)
    ...
    dsets["test"] = ImageList(txt_test, transform=image_test(), root=root_path)

...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        # print(- torch.log(pos_sim).mean())
        # print(- torch.log(sim_matrix.sum(dim=-1)).mean())
        contrast_loss = (- torch.log(pos_sim / sim_matrix.sum(dim=-1) * mas)).mean()
        print("imloss:{:.2f}, bnloss:{:.2f}, classifier_loss:{:.2f}, contrast_loss:{:.2f}".format(-gentropy_loss, bn_loss, classifier_loss, contrast_loss))

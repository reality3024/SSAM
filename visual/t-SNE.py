...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        tSNE(dset_loaders, netF, netB, netF_orignal, netB_orignal, netC, args, iter_num)
        iter_num += 1
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            # tSNE(dset_loaders, netF, netB, netF_orignal, netB_orignal, netC, args, iter_num // len(dset_loaders["target"]))
...
def tSNE(loader, netF, netB, netF_orignal, netB_orignal, netC, args, e):
    netF.eval()
    netB.eval()
    ...
    plt.savefig(args.name+'reallabel{}.png'.format(e))
